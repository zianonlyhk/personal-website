...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        title: "Zian Huang",
        description:
            "Personal website of Zian Huang: explore his technical projects, blog post, and creative artworks.",
        siteName: "Zian Huang",
        images: [
            {
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
    const structuredData = {
        ...
        description:
            "Computational fluid dynamics researcher and software engineer specializing in numerical methods, mathematics, and web development.",
        url: "https://zianhuang.com",
        sameAs: ["https://github.com/zianhuang"],
        knowsAbout: [
